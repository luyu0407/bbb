...
public class HorizontalView extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (getChildCount() == 0) {
            ...
            int childW = view1.getMeasuredWidth();
            int childH = view1.getMeasuredHeight();
            setMeasuredDimension(childW * getChildCount(), childH);
            ...
            View childOne = getChildAt(0);
            int childH = childOne.getMeasuredHeight();
            setMeasuredDimension(widthSize, childH);
        }
    }
...
//                child.layout(left, 0, left + width, child.getMeasuredHeight());
                left += lp.leftMargin + width + lp.rightMargin;
            }
        }
    }
}
